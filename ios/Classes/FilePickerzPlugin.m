...
@interface FilePickerzPlugin() <DKImageAssetExporterObserver>
#else
@interface FilePickerzPlugin()
#endif
...
@implementation FilePickerzPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"flutter.plugins.filepicker"
                                     binaryMessenger:[registrar messenger]];
    
    FlutterEventChannel* eventChannel = [FlutterEventChannel
                                         eventChannelWithName:@"flutter.plugins.filepickerevent"
                                         binaryMessenger:[registrar messenger]];
    
    FilePickerzPlugin* instance = [[FilePickerzPlugin alloc] init];
