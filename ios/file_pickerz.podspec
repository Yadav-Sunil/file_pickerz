...
A new Flutter project.
                       DESC
  s.homepage         = 'https://github.com/Yadav-Sunil/file_pickerz'
  ...
  s.pod_target_xcconfig = { 'DEFINES_MODULE' => 'YES', 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'i386', 'GCC_PREPROCESSOR_DEFINITIONS' => preprocess_definitions.join(' ') }
