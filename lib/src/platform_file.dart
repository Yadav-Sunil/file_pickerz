...
class PlatformFile {
  ...
  /// Read more about it [here](https://github.com/Yadav-Sunil/flutter_file_picker/wiki/FAQ)
  String? _path;

  String? get path {
    if (kIsWeb) {
      /// https://github.com/Yadav-Sunil/flutter_file_picker/issues/751
      throw '''
  ...
  /// [Check here in the FAQ](https://github.com/Yadav-Sunil/flutter_file_picker/wiki/FAQ) an example on how to use it to upload on web.
