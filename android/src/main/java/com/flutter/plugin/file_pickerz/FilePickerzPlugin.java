package com.flutter.plugin.file_pickerz;
...
public class FilePickerzPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {

    private static final String TAG = "FilePicker";
    private static final String CHANNEL = "flutter.plugins.filepicker";
    private static final String EVENT_CHANNEL = "flutter.plugins.filepickerevent";
    ...
    public static void registerWith(final io.flutter.plugin.common.PluginRegistry.Registrar registrar) {
        ...
        final FilePickerzPlugin plugin = new FilePickerzPlugin();
    ...
    public void onMethodCall(final MethodCall call, final MethodChannel.Result rawResult) {
        ...
        fileType = FilePickerzPlugin.resolveType(call.method);
